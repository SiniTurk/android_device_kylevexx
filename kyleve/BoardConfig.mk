...
BOARD_BLUEDROID_VENDOR_CONF := device/samsung/kylevexx/kyleve/bluetooth/libbt_vndcfg_S7392.txt
...
# Hardware rendering
BOARD_EGL_CFG := device/samsung/kylevexx/kyleve/configs/egl.cfg
...
TARGET_RECOVERY_FSTAB := device/samsung/kylevexx/kyleve/ramdisk/fstab.hawaii_ss_kyleve
...
# CMHW
BOARD_HARDWARE_CLASS := hardware/samsung/cmhw/ device/samsung/kylevexx/kyleve/cmhw/

# GPS
TARGET_SPECIFIC_HEADER_PATH := device/samsung/kylevexx/kyleve/include
...
BOARD_SEPOLICY_DIRS += \
    device/samsung/kylevexx/kyleve/sepolicy
